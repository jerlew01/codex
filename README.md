...
This repository includes a minimal HTTP proxy (`simple_proxy.py`).
Run it first and then point Proxifier at the proxy using these settings:
...
After the proxy is running, launch the main script:

```
python3 mobile_ip_browser
```
